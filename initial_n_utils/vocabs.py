...
measures_vocab={'waist':'ОТ', 'hips':"ОБ", 'bust':"ОГ", 'back_length_till_waist':"ДИ до талии", 'garment_length':"ДИ", 'hem':"Ширина отделки низа", 'shoulder_width':"ШП", 'bust_separation':"ЦГ",
